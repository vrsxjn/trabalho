 ...
 * @author Samuel
 */
public class Dados_pacientes extends javax.swing.JFrame {

    /**
     * Creates new form Dados_pacientes
     */
    public Dados_pacientes() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dados_pacientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dados_pacientes().setVisible(true);
            }
        });
    }
