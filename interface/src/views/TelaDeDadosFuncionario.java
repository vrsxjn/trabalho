 ...
 * @author gabri
 */
public class TelaDeDadosFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeConsultaPaciente
     */
    public TelaDeDadosFuncionario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeDadosFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeDadosFuncionario().setVisible(true);
            }
        });
    }
