 ...
 * @author gabri
 */
public class TelaDeDadosFuncionarios extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeConsultaPaciente
     */
    public TelaDeDadosFuncionarios() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consultar Administrador, Atendente ou Médico.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeDadosFuncionarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeDadosFuncionarios().setVisible(true);
            }
        });
    }
